...
<body>
	...
	<nav class="navbar navbar-default" action="/Library/search"
		method="post">
	...
	<ul class="breadcrumb">
		...
		<li class="active">修改书籍(<span style="color: red;">不填写选项则默认不修改</span>)
		</li>
	</ul>
	<div id="ub_main">
		<form action="/Library/book?msg=updatebook" method="post">

			<c:if test="${findABook!=null}">

				<p class="tb_left">
					<span>编&emsp;&emsp;号</span>&emsp;&emsp;<input
						placeholder="${findABook.bookid}" type="text" readonly
						unselectable="on">
				</p>
				<p>
					<span class="tb_left">书&emsp;&emsp;名</span>&emsp;&emsp;<input
						type="text" placeholder="${findABook.bookname}" name="bookname">
				</p>
				<p>
					<span class="tb_left">类&emsp;&emsp;型&emsp;&emsp;</span><select
						name="type">

						<option selected="selected" value="${findABook.type}"
							style="color: red;">${findABook.type}</option>
				...
				<p>
					<span class="tb_left">作&emsp;&emsp;者</span>&emsp;&emsp;<input
						type="text" placeholder="${findABook.author}" name="author">
				</p>
				<p>
					<span class="tb_left">价&emsp;&emsp;格</span>&emsp;&emsp;<input
						type="text" placeholder="${findABook.price}" name="price">
				</p>
				<p>

					<textarea rows="3" cols="35" placeholder="添加备注信息,100字以内"
						name="state"></textarea>
				</p>

			</c:if>

			<input type="submit" value="朕要提交" id="ub_sub">&emsp;<input
				type="reset" value="重置" id="ub_reset">
		</form>
